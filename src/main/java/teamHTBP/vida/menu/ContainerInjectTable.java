...
public class ContainerInjectTable extends ModBaseMenu {
    ...
    public ContainerInjectTable(int id, Inventory inventory, ItemStack itemStack, BlockPos pos, Level world) {
        super(ContainerTypeLoader.inject.get(), id, inventory);
