package teamHTBP.vida.menu.slot;
...
public class BluePrintSlot {
     ...
     * 此格子附近的格子实例
     */
    public LinkedList<BluePrintSlot> neibourSlot;

    public BluePrintSlot(BluePrintSlotPosition position) {
     ...
     * 设置此格子周围的格子
     */
    public void setNeibourSlots(BluePrintSlot... slots) throws NullPointerException {
    ...
    public void setHasItem(ItemStack stack) {
        this.hasItem = stack != null && stack != ItemStack.EMPTY;
    }
