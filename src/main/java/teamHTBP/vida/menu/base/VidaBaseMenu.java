package teamHTBP.vida.menu.base;
 ...
 * @author DustW
 **/
public abstract class VidaBaseMenu extends AbstractContainerMenu {
    public final Inventory inventory;
    public final IItemHandler invHandler;

    public VidaBaseMenu(MenuType<?> type, int pContainerId, Inventory inventory) {
