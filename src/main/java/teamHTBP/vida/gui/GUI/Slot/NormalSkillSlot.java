...
public class NormalSkillSlot extends AbstractSkillSlot {
    ...
    /**该技能框所包含的技能*/
    private SkillSurface skillSurface;
    ...
    public void renderSkillFrame(){
        ...
        switch (skillSurface.getSkillType()){
            case NORMAL: break;
            case PlATIUM: offsetU = 42 * 3;break;
            case BRONZE: offsetU = 42 * 2;break;
            case GOLD: offsetU = 42 * 1;break;
            case SILVER: offsetU = 42 *1;break;
        }
        if(!mouseFocus) blit(this.x,this.y,0,0 + offsetU,254,42,48,512,512);
        else blit(this.x,this.y,0,0 + offsetU,302,42,48,512,512);
    ...
    public void renderSkill(){
        ...
        blit((int)((this.x + 6) * 1.25) + 4 , (int)((this.y + 9) * 1.25) + 3,0,skillSurface.getSkillTextureU(),skillSurface.getSkillTextureV(),32,32,256,256);
        RenderSystem.popMatrix();
    }
    ...
    public void drawProgress(){
        ...
        if(progress < 50)
            blit(this.x + 21, this.y + 4, 0, 21 , 352 , 17 , (int)(40 * progress / 50) , 512 ,512);
        else {
            blit(this.x + 21, this.y + 4, 0, 21, 352, 17, 40, 512, 512);
            blit(this.x, this.y + 44 - (int)(40 * (progress - 50)/ 50), 0, 0, 392 - (int)(40 * (progress - 50)/ 50), 21, (int)(40 * (progress - 50) / 50), 512, 512);
        }
        RenderSystem.popMatrix();
    }
    ...
    public void renderLock(){
        ...
        Minecraft minecraft = Minecraft.getInstance();
        minecraft.getTextureManager().bindTexture(Gui);
        blit(this.x + 13 , this.y + 12,0, 0 ,170,15,23,512,512);
        RenderSystem.popMatrix();
    }
}
