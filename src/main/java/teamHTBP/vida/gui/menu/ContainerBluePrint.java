...
public class ContainerBluePrint extends ModBaseMenu {
    public final int[][] slotPositions = {{83, 41}, {108, 41}, {71, 64}, {96, 64}, {121, 64}, {83, 87}, {108, 87}};

    public ContainerBluePrint(int id, Inventory inventory, ItemStack stack) {
        super(ContainerTypeLoader.bluePrints.get(), id, inventory);
