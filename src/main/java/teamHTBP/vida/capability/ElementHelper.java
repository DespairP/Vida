...
public class ElementHelper {
    ...
    public static Allelopathy getRelationShip(int elementA,int elementB){
        Set<Integer> keySet = new HashSet<Integer>();
        keySet.add(elementA);keySet.add(elementB);
        if(keySet.size() == 1) return Allelopathy.Identical;
        else if(keySet.contains(0)) return Allelopathy.UnDefined;
        else if((keySet.contains(1) && keySet.contains(3)) ||
                (keySet.contains(3) && keySet.contains(2)) ||
                (keySet.contains(2) && keySet.contains(4)) ||
                (keySet.contains(4) && keySet.contains(5)) ||
                 keySet.contains(1) && keySet.contains(5)) return Allelopathy.InterGrowth;
        else if((keySet.contains(1) && keySet.contains(2)) ||
                (keySet.contains(3) && keySet.contains(4)) ||
                (keySet.contains(4) && keySet.contains(1)) ||
                (keySet.contains(3) && keySet.contains(5)) ||
                 keySet.contains(2) && keySet.contains(5)) return Allelopathy.Conflict;
        return Allelopathy.UnDefined;
    }

    public enum Allelopathy{
        Conflict,InterGrowth,UnDefined,Identical
    }
