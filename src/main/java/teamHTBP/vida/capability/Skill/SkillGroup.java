...
public class SkillGroup{
    ...
    public SkillGroup appendSkill(ISkill skill,EnumSkillDirection skillDirection){
        switch (skillDirection){
            case TopLeft:
                skill.setSkillPosition(centerX - 25,centerY - 46);break;
            case TopRight:
                skill.setSkillPosition(centerX + 25,centerY - 46);break;
            case Left:
                skill.setSkillPosition(centerX - 49, centerY);break;
            case Right:
                skill.setSkillPosition(centerX + 49, centerY);break;
            case BottomLeft:
                skill.setSkillPosition(centerX - 25, centerY + 46);break;
    ...
    public SkillGroup appendSkillWithBranch(ISkill skill,EnumSkillDirection skillDirection){
        ...
        switch (skillDirection){
            case TopLeft:
                childGroup.setCenter(centerX - 25,centerY - 46);break;
            case TopRight:
                childGroup.setCenter(centerX + 25,centerY - 46);break;
            case Left:
                childGroup.setCenter(centerX - 49, centerY);break;
            case Right:
                childGroup.setCenter(centerX + 49, centerY);break;
            case BottomLeft:
                childGroup.setCenter(centerX - 25, centerY + 46);break;
