package teamHTBP.vida.common.datapack;
...
import teamHTBP.vida.common.datapack.blueprint.BlueprintManager;
import teamHTBP.vida.common.datapack.element.ElementPotentialManager;
...
public class VidaDataPackLoader {
    ...
    static <T extends AbstractVidaDataPack<T>> DeferredRegister<T> register(
            T instance,
            Codec<T> codec
    ) {
