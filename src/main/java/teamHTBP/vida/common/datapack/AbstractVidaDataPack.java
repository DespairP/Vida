 ...
 * @author DustW
 */
public abstract class AbstractVidaDataPack<T> extends SimpleJsonResourceReloadListener implements IForgeRegistryEntry<T> {
    ...
    public AbstractVidaDataPack(Gson gson, String path) {
        super(gson, path);
