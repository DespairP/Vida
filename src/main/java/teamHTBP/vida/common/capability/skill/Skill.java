package teamHTBP.vida.common.capability.skill;
...
public class Skill implements ISkill {
     ...
     */
    public void setSkillTextureU(int textureX) {
        this.textureU = textureX;
    }
     ...
     */
    public void setSkillTextureV(int textureY) {
        this.textureV = textureY;
    }
