...
public class BottlesMenu extends VidaBaseMenu {
    ItemStack stack;
    public Boolean isStack3Lock = true;

    public BottlesMenu(int id, Inventory inv, ItemStack stack) {
        super(VidaMenuTypeLoader.bottles.get(), id, inv);
        //getNBT
        ...
        if (((ItemArmorElementLegginsWithBottles) stack.getItem()).element == 2) {
            ...
            this.addSlot(new PrismTableMenu.FobiddenSlot(new SimpleContainer(bottle3), 0, 101, 11));
        }
