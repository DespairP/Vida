...
public class OreReactionMachineMenu extends VidaBaseMenu {
    public OreReationMachineBlockEntity machine;

    public OreReactionMachineMenu(int winId, Inventory inventory, BlockPos pos, Level world, OreReactionMachineData array) {
        super(VidaMenuTypeLoader.oreReaction.get(), winId, inventory);
        OreReationMachineBlockEntity oreReationMachine = (OreReationMachineBlockEntity) world.getBlockEntity(pos);
        ...
        this.addSlot(new PrismTableMenu.FobiddenSlot(oreReationMachine.getCompleteSlot(), 0, 75, 90 - 30));
