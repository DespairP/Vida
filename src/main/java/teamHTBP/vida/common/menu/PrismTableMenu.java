...
public class PrismTableMenu extends VidaBaseMenu {
    private final PrismTableData array;
    public PrismTableBlockEntity prismTableBlockEntity;

    public PrismTableMenu(int winId, Inventory inventory, BlockPos pos, Level world, PrismTableData array) {
        super(VidaMenuTypeLoader.prismTable.get(), winId, inventory);
        this.array = array;
        this.prismTableBlockEntity = (PrismTableBlockEntity) world.getBlockEntity(pos);
        this.addSlot(new Slot(prismTableBlockEntity.getSlot(), 0, 10, 16));
        this.addSlot(new Slot(prismTableBlockEntity.getSlot(), 1, 28, 16));
        this.addSlot(new FobiddenSlot(prismTableBlockEntity.getSlot(), 2, 44, 59));
