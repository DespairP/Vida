...
public class VidaGenerationLoader {
    ...
    public static final RegistryObject<ConfiguredFeature<?, ?>> VIDA_TREE =
            CONFIGURED_FEATURE.register("vida_tree", () ->
                    new ConfiguredFeature<>(VIDA_TREE_FEATURE.get(), new TreeConfiguration.TreeConfigurationBuilder(
                            BlockStateProvider.simple(VidaBlockLoader.logVida.get().defaultBlockState()),
                            new StraightTrunkPlacer(
                                    10, 2, 2
                            ),
                            BlockStateProvider.simple(VidaBlockLoader.leavesVida.get().defaultBlockState()),
    ...
    public static final RegistryObject<PlacedFeature> aquaElementOre = ore(VidaBlockLoader.aquaElementOre);
    public static final RegistryObject<PlacedFeature> goldElementOre = ore(VidaBlockLoader.goldElementOre);
    public static final RegistryObject<PlacedFeature> fireElementOre = ore(VidaBlockLoader.fireElementOre);
    public static final RegistryObject<PlacedFeature> earthElementOre = ore(VidaBlockLoader.earthElementOre);
    public static final RegistryObject<PlacedFeature> woodElementOre = ore(VidaBlockLoader.woodElementOre);
