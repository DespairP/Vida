...
import teamHTBP.vida.common.item.staff.*;
...
public class ItemLoader {
    ...
    public final static RegistryObject<Item> logVida = ITEMS.register("logvida", () -> new BlockItem(VidaBlockLoader.logVida.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));
    public static RegistryObject<Item> leavesVida = ITEMS.register("leavesvida", () -> new BlockItem(VidaBlockLoader.leavesVida.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));
    public static RegistryObject<Item> plankvida_0 = ITEMS.register("plankvida0", () -> new BlockItem(VidaBlockLoader.plankVida_0.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));
    public static RegistryObject<Item> plankvida_1 = ITEMS.register("plankvida1", () -> new BlockItem(VidaBlockLoader.plankVida_1.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));
    public static RegistryObject<Item> plankvida_2 = ITEMS.register("plankvida2", () -> new BlockItem(VidaBlockLoader.plankVida_2.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));


    public static RegistryObject<Item> goldElementOre = ITEMS.register("goldelementore", () -> new BlockItem(VidaBlockLoader.goldElementOre.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));
    public static RegistryObject<Item> woodElementOre = ITEMS.register("woodelementore", () -> new BlockItem(VidaBlockLoader.woodElementOre.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));
    public static RegistryObject<Item> aquaElementOre = ITEMS.register("aquaelementore", () -> new BlockItem(VidaBlockLoader.aquaElementOre.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));
    public static RegistryObject<Item> fireElementOre = ITEMS.register("fireelementore", () -> new BlockItem(VidaBlockLoader.fireElementOre.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));
    public static RegistryObject<Item> earthElementOre = ITEMS.register("earthelementore", () -> new BlockItem(VidaBlockLoader.earthElementOre.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));


    public static RegistryObject<Item> samping = ITEMS.register("saplingvida", () -> new BlockItem(VidaBlockLoader.saplingVida.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));

    public static RegistryObject<Item> plankLush = ITEMS.register("lush_planks", () -> new BlockItem(VidaBlockLoader.LUSH_PLANKS.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));
    ...
    public static RegistryObject<Item> prismTable = ITEMS.register("prismtable", () -> new BlockItem(VidaBlockLoader.prismTable.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP).maxStackSize(1)));
    public static RegistryObject<Item> oreReactionMachine = ITEMS.register("orereactionmachine", () -> new BlockItem(VidaBlockLoader.oreReactionMachine.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));
    public static RegistryObject<Item> collector = ITEMS.register("collector", () -> new BlockItem(VidaBlockLoader.collector.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));
    public static RegistryObject<Item> injectionTable = ITEMS.register("injecttable", () -> new BlockItem(VidaBlockLoader.injectionTable.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));
    public static RegistryObject<Item> altarcubeMaker = ITEMS.register("altarcubemaker", () -> new BlockItem(VidaBlockLoader.altarcubeMaker.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));
    public static RegistryObject<Item> steleLife = ITEMS.register("lifestele", () -> new BlockItem(VidaBlockLoader.steleLife.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));
    public static RegistryObject<Item> blueprintDesigner = ITEMS.register("blueprintdesigner", () -> new BlockItem(VidaBlockLoader.blueprintDesigner.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));
    public static RegistryObject<Item> purfiedCauldron = ITEMS.register("purfiedcauldron", () -> new BlockItem(VidaBlockLoader.purfiedCauldron.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));

    //悬浮元素水晶方块
    public static RegistryObject<Item> goldElementCrystal = ITEMS.register("goldelementcrystal", () -> new BlockItem(VidaBlockLoader.elementCrystalGold.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));
    public static RegistryObject<Item> woodElementCrystal = ITEMS.register("woodelementcrystal", () -> new BlockItem(VidaBlockLoader.elementCrystalWood.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));
    public static RegistryObject<Item> aquaElementCrystal = ITEMS.register("aquaelementcrystal", () -> new BlockItem(VidaBlockLoader.elementCrystalAqua.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));
    public static RegistryObject<Item> fireElementCrystal = ITEMS.register("fireelementcrystal", () -> new BlockItem(VidaBlockLoader.elementCrystalFire.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));
    public static RegistryObject<Item> earthElementCrystal = ITEMS.register("earthelementcrystal", () -> new BlockItem(VidaBlockLoader.elementCrystalEarth.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));

    //元素农作物方块
    public static RegistryObject<Item> CROP_CRISMCREST = ITEMS.register("crop_crimsoncrest", () -> new BlockItem(VidaBlockLoader.CROP_CRISMCREST.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));
    public static RegistryObject<Item> CROP_HEARTOFWAL = ITEMS.register("crop_heartofwal", () -> new BlockItem(VidaBlockLoader.CROP_HEARTOFWAL.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));
    public static RegistryObject<Item> CROP_NITRITETHORNS = ITEMS.register("crop_nitritethorns", () -> new BlockItem(VidaBlockLoader.CROP_NITRITETHORNS.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));
    public static RegistryObject<Item> CROP_PLAMSTEM = ITEMS.register("crop_plamstem", () -> new BlockItem(VidaBlockLoader.CROP_PLAMSTEM.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));
    public static RegistryObject<Item> CROP_SULLENHYDRANGEA = ITEMS.register("crop_sullenhydrangea", () -> new BlockItem(VidaBlockLoader.CROP_SULLENHYDRANGEA.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));
    public static RegistryObject<Item> CROP_SWEETCYANREED = ITEMS.register("crop_sweetcyanreed", () -> new BlockItem(VidaBlockLoader.CROP_SWEETCYANREED.get(), new Item.Properties().group(ItemGroupLoader.VIDA_ITEM_GROUP)));
