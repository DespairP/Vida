...
public class InjectTableBlockEntity extends VidaBaseMenuBlockEntity {
    //将要被注魔的剑
    ItemStack swordStack = ItemStack.EMPTY;

    public InjectTableBlockEntity(BlockPos pWorldPosition, BlockState pBlockState) {
        super(VidaBlockEntityLoader.TileEntityInjectTable.get(), pWorldPosition, pBlockState);
    }
