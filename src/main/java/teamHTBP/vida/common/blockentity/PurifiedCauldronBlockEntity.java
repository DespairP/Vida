...
public class PurifiedCauldronBlockEntity extends VidaBaseBlockEntity {
    //满提炼值
    ...
    public PurifiedCauldronBlockEntity(BlockPos pWorldPosition, BlockState pBlockState) {
        super(VidaBlockEntityLoader.TileEntityPurfiedCauldron.get(), pWorldPosition, pBlockState);
    }
    ...
    public void generateFaintLight() {
        if (container > MAX_CONTAINER - 1) {
            FaintLight faintLight = new FaintLight(VidaEntityLoader.faintLight.get(), level, element);
