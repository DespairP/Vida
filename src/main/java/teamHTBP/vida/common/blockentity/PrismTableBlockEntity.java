...
public class PrismTableBlockEntity extends VidaBaseMenuBlockEntity {
    //Slot的inventory
    ...
    public PrismTableBlockEntity(BlockPos pWorldPosition, BlockState pBlockState) {
        super(VidaBlockEntityLoader.TileEntityPrismTable.get(), pWorldPosition, pBlockState);
    }
    ...
    public void tick() {
        ...
        this.isMirror = this.slot.getItem(1).getItem() == VidaItemLoader.prism.get();
    ...
    public ItemStack getItemGemFromElement(IElement element) {
        if (element instanceof EnumElements) {
            switch ((EnumElements) element) {
                case GOLD:
                    return new ItemStack(VidaItemLoader.ARTIFICIAL_ELEMENTGEM_GOLD.get(), 1);
                case WOOD:
                    return new ItemStack(VidaItemLoader.ARTIFICIAL_ELEMENTGEM_WOOD.get(), 1);
                case AQUA:
                    return new ItemStack(VidaItemLoader.ARTIFICIAL_ELEMENTGEM_AQUA.get(), 1);
                case FIRE:
                    return new ItemStack(VidaItemLoader.ARTIFICIAL_ELEMENTGEM_FIRE.get(), 1);
                case EARTH:
                    return new ItemStack(VidaItemLoader.ARTIFICIAL_ELEMENTGEM_EARTH.get(), 1);
            }
        }
