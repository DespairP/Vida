...
public class ArmorModelEarthBoots extends ArmorModelElementBoots {
    ...
    public ArmorModelEarthBoots(){
        ...
        leg_right.setTextureOffset(22, 56).addBox(-2.0F, 0.0F, -2.0F, 4.5F, 2.0F, 4.5F, 0.0F, false);
        leg_right.setTextureOffset(38, 56).addBox(-2.0F, 7.0F, -2.0F, 4.5F, 5.0F, 4.5F, 0.0F, false);
        leg_right.setTextureOffset(54, 61).addBox(-1.5F, 5.0F, -2.5F, 3.5F, 3.0F, 1.5F, 0.0F, false);

        bone = new ModelRenderer(this);
        bone.setRotationPoint(0.0F, 12.25F, -1.75F);
        leg_right.addChild(bone);
        ...
        leg_left.setTextureOffset(22, 56).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 2.0F, 4.0F, 0.0F, true);
        leg_left.setTextureOffset(38, 56).addBox(-2.0F, 7.0F, -2.0F, 4.0F, 5.0F, 4.0F, 0.0F, true);
        leg_left.setTextureOffset(54, 61).addBox(-1.5F, 5.0F, -2.5F, 3.0F, 3.0F, 1.0F, 0.0F, true);

        bone2 = new ModelRenderer(this);
        bone2.setRotationPoint(0.0F, 12.25F, -1.75F);
        leg_left.addChild(bone2);
