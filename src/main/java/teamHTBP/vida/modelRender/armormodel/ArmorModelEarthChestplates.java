...
public class ArmorModelEarthChestplates extends ArmorModelElementChestplates {
    ...
    public ArmorModelEarthChestplates(){
        ...
        arm_right.setTextureOffset(26, 36).addBox(-5.25F, -2.0F, -2.5F, 3.0F, 5.0F, 5.0F, 0.0F, true);
        ...
        arm_right.setTextureOffset(16, 38).addBox(-5.0F, 6.5F, -2.0F, 1.0F, 4.0F, 4.0F, 0.0F, true);

        arm_left = new ModelRenderer(this);
        arm_left.setRotationPoint(4.0F, 1.0F, 0.0F);
        arm_left.setTextureOffset(26, 36).addBox(2.25F, -2.0F, -2.5F, 3.0F, 5.0F, 5.0F, 0.0F, false);
        ...
        arm_left.setTextureOffset(16, 38).addBox(4.0F, 6.5F, -2.0F, 1.0F, 4.0F, 4.0F, 0.0F, false);
