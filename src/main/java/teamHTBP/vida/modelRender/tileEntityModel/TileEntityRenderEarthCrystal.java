...
public class TileEntityRenderEarthCrystal extends ModBlockEntityRenderer<TileEntityEarthElementCrystal> {
    public ResourceLocation ELEMENT_CRYSTAL;
    private int element = 0;

    public TileEntityRenderEarthCrystal(BlockEntityRendererProvider.Context context, int element) {
        super(context);
