...
public class TileEntityRenderEarthCrystal extends BlockEntityRenderer<TileEntityEarthElementCrystal> {
    public ResourceLocation ELEMENT_CRYSTAL;
    private int element = 0;

    public TileEntityRenderEarthCrystal(BlockEntityRenderDispatcher rendererDispatcherIn, int element) {
    ...
    @Override
    public void render(TileEntityEarthElementCrystal tileEntityIn, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn) {
