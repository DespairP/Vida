...
public class TileEntityRenderLoaderAquaCrystal extends BlockEntityRenderer<TileEntityAquaElementCrystal> {
    public ResourceLocation ELEMENT_CRYSTAL;
    private int element = 0;

    public TileEntityRenderLoaderAquaCrystal(BlockEntityRenderDispatcher rendererDispatcherIn, int element) {
    ...
    @Override
    public void render(TileEntityAquaElementCrystal tileEntityIn, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn) {
