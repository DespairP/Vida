...
public class TileEntityRenderLoaderAquaCrystal extends ModBlockEntityRenderer<TileEntityAquaElementCrystal> {
    public ResourceLocation ELEMENT_CRYSTAL;
    private int element = 0;

    public TileEntityRenderLoaderAquaCrystal(BlockEntityRendererProvider.Context context, int element) {
        super(context);
