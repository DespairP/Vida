...
public class TileEntityRenderFireCrystal extends BlockEntityRenderer<TileEntityFireElementCrystal> {
    public ResourceLocation ELEMENT_CRYSTAL;
    private int element = 0;

    public TileEntityRenderFireCrystal(BlockEntityRenderDispatcher rendererDispatcherIn, int element) {
    ...
    @Override
    public void render(TileEntityFireElementCrystal tileEntityIn, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn) {
