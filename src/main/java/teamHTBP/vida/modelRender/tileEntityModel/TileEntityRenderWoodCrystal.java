...
public class TileEntityRenderWoodCrystal extends ModBlockEntityRenderer<TileEntityWoodElementCrystal> {
    public ResourceLocation ELEMENT_CRYSTAL;
    private int element = 0;

    public TileEntityRenderWoodCrystal(BlockEntityRendererProvider.Context context, int element) {
        super(context);
