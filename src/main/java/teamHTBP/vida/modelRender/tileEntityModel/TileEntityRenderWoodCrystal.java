...
public class TileEntityRenderWoodCrystal extends BlockEntityRenderer<TileEntityWoodElementCrystal> {
    public ResourceLocation ELEMENT_CRYSTAL;
    private int element = 0;

    public TileEntityRenderWoodCrystal(BlockEntityRenderDispatcher rendererDispatcherIn, int element) {
    ...
    @Override
    public void render(TileEntityWoodElementCrystal tileEntityIn, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn) {
