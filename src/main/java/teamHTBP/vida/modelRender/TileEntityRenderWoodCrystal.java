...
public class TileEntityRenderWoodCrystal extends TileEntityRenderer<TileEntityWoodElementCrystal> {
    private int element = 0;
    public ResourceLocation ELEMENT_CRYSTAL;
    public TileEntityRenderWoodCrystal(TileEntityRendererDispatcher rendererDispatcherIn, int element) {
    ...
    @Override
    public void render(TileEntityWoodElementCrystal tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
        matrixStackIn.push();
