...
public class BlockElementCropParticle extends AbstractBlockElementCrops{
     ...
     * */
    public BlockElementCropParticle(int stage, int element,IItemProvider provider,ColorHelper helper) {
        super(stage, element);
     ...
     * */
    public BlockElementCropParticle(int stage, int element,IItemProvider provider,ColorHelper helper,boolean isMutations) {
        super(stage, element);
        this.provider = provider;
        this.color = helper;
