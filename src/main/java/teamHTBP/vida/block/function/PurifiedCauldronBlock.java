...
import teamHTBP.vida.block.base.VidaBaseEntityBlock;
...
public class PurifiedCauldronBlock extends VidaBaseEntityBlock<TileEntityPurifiedCauldron> {
    ...
    public InteractionResult use(BlockState state, Level worldIn, BlockPos pos, Player player, InteractionHand handIn, BlockHitResult hit) {
        if (handIn == InteractionHand.MAIN_HAND) {
            TileEntityPurifiedCauldron entity = (TileEntityPurifiedCauldron) worldIn.getBlockEntity(pos);
            //如果是创造模式不消耗水桶
            //如果是就消耗水桶
