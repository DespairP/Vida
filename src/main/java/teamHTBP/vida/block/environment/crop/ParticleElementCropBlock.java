...
public class ParticleElementCropBlock extends AbstractElementCropsBlock {
     ...
     */
    public ParticleElementCropBlock(int stage, IElement element, ItemLike provider, ColorHelper helper) {
        super(stage, element);
     ...
     */
    public ParticleElementCropBlock(int stage, IElement element, ItemLike provider, ColorHelper helper, boolean isMutations) {
        super(stage, element);
        this.provider = provider;
        this.color = helper;
