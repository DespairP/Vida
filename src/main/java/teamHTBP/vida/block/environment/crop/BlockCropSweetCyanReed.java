...
public class BlockCropSweetCyanReed extends AbstractBlockElementCrops {
    public BlockCropSweetCyanReed(int stage, IElement element) {
        super(stage, element);
    }
    ...
    public void animateTick(BlockState stateIn, Level worldIn, BlockPos pos, Random rand) {
        ...
        if (isMaxAge(stateIn) && rand.nextFloat() >= 0.75f) {
            ...
            worldIn.addParticle(new DustParticleOptions(new Vector3f(78.0F / 255.0F, 255.0F / 255.0F, 163.0F / 255.0F), 1), x + offsetX, y + 0.4f, z + offsetZ, 0, 0, 0);
