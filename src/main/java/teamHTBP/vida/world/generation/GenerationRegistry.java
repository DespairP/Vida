...
public class GenerationRegistry {
    ...
    public static final RegistryObject<ConfiguredFeature<?, ?>> VIDA_TREE =
            CONFIGURED_FEATURE.register("vida_tree", () ->
                    new ConfiguredFeature<>(VIDA_TREE_FEATURE.get(), new TreeConfiguration.TreeConfigurationBuilder(
                            BlockStateProvider.simple(VidaBlockRegistry.logVida.get().defaultBlockState()),
                            new StraightTrunkPlacer(
                                    10, 2, 2
                            ),
                            BlockStateProvider.simple(VidaBlockRegistry.leavesVida.get().defaultBlockState()),
    ...
    public static final RegistryObject<PlacedFeature> aquaElementOre = ore(VidaBlockRegistry.aquaElementOre);
    public static final RegistryObject<PlacedFeature> goldElementOre = ore(VidaBlockRegistry.goldElementOre);
    public static final RegistryObject<PlacedFeature> fireElementOre = ore(VidaBlockRegistry.fireElementOre);
    public static final RegistryObject<PlacedFeature> earthElementOre = ore(VidaBlockRegistry.earthElementOre);
    public static final RegistryObject<PlacedFeature> woodElementOre = ore(VidaBlockRegistry.woodElementOre);
