...
public class ItemElementPickaxe extends ToolItem implements IElementLevelTools {
    ...
    public ItemElementPickaxe(EnumElements element) {
        super(1, -2.8f, new ElementItemTier(), EFFECTIVE_ON, new Properties().tab(ItemGroupLoader.vidaItemGroup).addToolType(net.minecraftforge.common.ToolType.PICKAXE, new ElementItemTier().getLevel()));
    ...
    public void appendHoverText(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        ITextComponent iTextComponent = new TranslationTextComponent(I18n.get("desc.picklevel.level"), level).withStyle(TextFormatting.GRAY);
        tooltip.add(iTextComponent);
        tooltip.add(new StringTextComponent("(" + exp + "/" + (level * 500) + ")").withStyle(TextFormatting.GREEN));
