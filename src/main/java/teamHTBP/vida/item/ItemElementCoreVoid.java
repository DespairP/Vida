                ...
                if(list.get(0) instanceof EntityFaintLight){
                     list.get(0).remove();
                         ...
                         switch (entityFaintLight.getFaintLightType()){
                             case 1:
                                 getStack = new ItemStack(ItemLoader.ELEMENTCORE_GOLD.get(),1);break;
                             case 2:
                                 getStack = new ItemStack(ItemLoader.ELEMENTCORE_WOOD.get(),1);break;
                             case  3:
                                 getStack = new ItemStack(ItemLoader.ELEMENTCORE_AQUA.get(),1);break;
                             case  4:
                                 getStack = new ItemStack(ItemLoader.ELEMENTCORE_FIRE.get(),1);break;
                             case 5:
                                 getStack = new ItemStack(ItemLoader.ELEMENTCORE_EARTH.get(),1);break;
                         }
