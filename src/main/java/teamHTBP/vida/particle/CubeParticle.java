...
public class CubeParticle extends SpriteTexturedParticle {
    ...
    protected CubeParticle(World World, double posX, double posY, double posZ, double speedX, double speedY, double speedZ,float r,float g,float b,float scale) {
        super(World,posX,posY,posZ,speedX,speedY,speedZ);
        this.canCollide = true;
        motionX = speedX;
        motionY = speedY;
    ...
    public void renderParticle(IVertexBuilder buffer, ActiveRenderInfo renderInfo, float partialTicks) {
        ...
        switch (rotationType) {
            case 1: quaternion = new Quaternion(this.particleAngle, this.particleAngle, 0, true);break;
            case 2: quaternion = new Quaternion(this.particleAngle, this.particleAngle, this.particleAngle, true);break;
            case 3: quaternion = new Quaternion(this.particleAngle, 0, this.particleAngle, true);break;
            case 4: quaternion = new Quaternion(0, this.particleAngle, this.particleAngle, true);break;
            case 5: quaternion = new Quaternion(0, this.particleAngle, 0, true);break;
            case 6: quaternion = new Quaternion(0, this.particleAngle, this.particleAngle, true);break;
            case 7: quaternion = new Quaternion(0, -this.particleAngle, -this.particleAngle, true);break;
            case 8: quaternion = new Quaternion(-this.particleAngle, -this.particleAngle, this.particleAngle, true);break;
            case 9: quaternion = new Quaternion(-this.particleAngle, -this.particleAngle, -this.particleAngle, true);break;
            case 10: quaternion = new Quaternion(0, this.particleAngle, -this.particleAngle, true);break;
        }
