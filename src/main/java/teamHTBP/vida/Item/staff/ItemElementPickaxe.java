...
public class ItemElementPickaxe extends ToolItem implements IElementTools {
    ...
    public ItemElementPickaxe(int element) {
    ...
    public void fillItemGroup(ItemGroup group, NonNullList<ItemStack> items) {
        ...
        stack.getOrCreateTag().putInt("pickaxeEXP", 0);
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        ITextComponent iTextComponent = new StringTextComponent(I18n.format("desc.picklevel.level")).applyTextStyle(TextFormatting.GRAY);
        iTextComponent.appendText(level + "");
        tooltip.add(iTextComponent);
        tooltip.add(new StringTextComponent("("+exp+"/"+(level  * 500)+")").applyTextStyle(TextFormatting.GREEN));
...
class ElementItemTier implements IItemTier{
    Item repairItem = ItemLoader.earthElementCore.get();
    ElementItemTier(){
    }
    @Override
