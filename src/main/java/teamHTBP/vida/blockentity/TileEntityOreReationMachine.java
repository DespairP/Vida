...
public class TileEntityOreReationMachine extends VidaBaseMenuBlockEntity {
    ...
    public TileEntityOreReationMachine(BlockPos pWorldPosition, BlockState pBlockState) {
        super(TileEntityLoader.TileEntityOreReationMachine.get(), pWorldPosition, pBlockState);
    }
