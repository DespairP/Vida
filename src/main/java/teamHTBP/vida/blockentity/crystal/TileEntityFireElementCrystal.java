...
public class TileEntityFireElementCrystal extends ModBaseBlockEntity implements IElementCrystal {
    ...
    public TileEntityFireElementCrystal(BlockPos pWorldPosition, BlockState pBlockState, int element) {
        super(TileEntityLoader.TileEntityCrystalFire.get(), pWorldPosition, pBlockState);
