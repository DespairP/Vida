package teamHTBP.vida.client.model.blockentity;// Made with Blockbench 3.9.3
...
@AutoRegModel
public class InjectTableModel extends VidaBlockEntityModel {
	...
	public InjectTableModel(ModelPart part) {
		...
		group = all.getChild("group");
		rotateCube = group.getChild("rotateCube");
		group2 = all.getChild("group2");
		cube_r1 = group2.getChild("cube_r1");
	}
