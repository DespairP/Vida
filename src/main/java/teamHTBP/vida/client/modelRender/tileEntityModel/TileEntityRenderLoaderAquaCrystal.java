...
public class TileEntityRenderLoaderAquaCrystal extends TileEntityRenderer<TileEntityAquaElementCrystal> {
    public ResourceLocation ELEMENT_CRYSTAL;
    private int element = 0;

    public TileEntityRenderLoaderAquaCrystal(TileEntityRendererDispatcher rendererDispatcherIn, int element) {
    ...
    @Override
    public void render(TileEntityAquaElementCrystal tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
        matrixStackIn.push();
