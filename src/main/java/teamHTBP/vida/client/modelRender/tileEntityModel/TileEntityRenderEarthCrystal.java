...
import teamHTBP.vida.common.TileEntity.TileEntityEarthElementCrystal;
import teamHTBP.vida.Vida;
import teamHTBP.vida.client.modelRender.RenderLoader;

public class TileEntityRenderEarthCrystal extends TileEntityRenderer<TileEntityEarthElementCrystal> {
    public ResourceLocation ELEMENT_CRYSTAL;
    private int element = 0;

    public TileEntityRenderEarthCrystal(TileEntityRendererDispatcher rendererDispatcherIn, int element) {
    ...
    @Override
    public void render(TileEntityEarthElementCrystal tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
        matrixStackIn.push();
