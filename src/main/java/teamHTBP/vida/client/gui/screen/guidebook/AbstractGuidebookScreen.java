...
public abstract class AbstractGuidebookScreen extends Screen implements IGuidebookScreen {
    ...
    /**状态管理器*/
    public final GuidebookManager manager;

    public AbstractGuidebookScreen(Component titleIn) {
        this(titleIn, GuidebookContext.empty());
    }

    public AbstractGuidebookScreen(Component titleIn, GuidebookContext context){
        super(titleIn);
