...
public class BluePrintScreen extends VidaBaseScreen<BluePrintMenu> {
    public final ResourceLocation GUI = new ResourceLocation(Vida.MOD_ID, "textures/gui/belt_gui.png");
    private final BluePrintMenu container;
    private ArrayList<BluePrintSlot> slots;

    public BluePrintScreen(BluePrintMenu screenContainer, Inventory inv, Component titleIn) {
    ...
    public void initBluePrintSlot() {
        slots = Lists.newArrayList(
                new BluePrintSlot(BluePrintSlot.BluePrintSlotPosition.TopLeft),
                new BluePrintSlot(BluePrintSlot.BluePrintSlotPosition.TopRight),
                new BluePrintSlot(BluePrintSlot.BluePrintSlotPosition.Left),
                new BluePrintSlot(BluePrintSlot.BluePrintSlotPosition.Middle),
                new BluePrintSlot(BluePrintSlot.BluePrintSlotPosition.Right),
                new BluePrintSlot(BluePrintSlot.BluePrintSlotPosition.BottomLeft),
                new BluePrintSlot(BluePrintSlot.BluePrintSlotPosition.BottomRight)
        );
     ...
     * 绘制格子
     */
    public void drawSlots(PoseStack matrixStack, BluePrintSlot slot) {
