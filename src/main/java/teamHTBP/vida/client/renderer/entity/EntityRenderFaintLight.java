...
public class EntityRenderFaintLight extends EntityRenderer<FaintLight> {
    ...
    @Override
    public ResourceLocation getTextureLocation(FaintLight entity) {
        if (entity.getFaintLightType() instanceof EnumElements) {
            switch ((EnumElements) entity.getFaintLightType()) {
                case GOLD:
                    return RenderRegistry.goldFaintLightLocation;
                case WOOD:
                    return RenderRegistry.woodFaintLightLocation;
                case AQUA:
                    return RenderRegistry.aquaFaintLightLocation;
                case FIRE:
                    return RenderRegistry.fireFaintLightLocation;
                case EARTH:
                    return RenderRegistry.earthFaintLightLocation;
            }
        }
        return RenderRegistry.earthFaintLightLocation;
    }
    ...
    @Override
    public void render(FaintLight entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
