 ...
 * @author DustW
 */
public class ElementBallRenderer extends EntityRenderer<ElementBallProjectile> {
    BallModel model;

    public ElementBallRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
    ...
    @Override
    public void render(ElementBallProjectile entity, float entityYaw, float partialTick, PoseStack poseStack,
    ...
    @Override
    public ResourceLocation getTextureLocation(ElementBallProjectile pEntity) {
        return TEXTURE;
    }
}
