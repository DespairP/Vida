...
public class TileEntityRenderFireCrystal extends ModBlockEntityRenderer<TileEntityFireElementCrystal> {
    public ResourceLocation ELEMENT_CRYSTAL;
    private int element = 0;

    public TileEntityRenderFireCrystal(BlockEntityRendererProvider.Context context, int element) {
        super(context);
